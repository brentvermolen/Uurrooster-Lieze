...
public class AmbilWarnaDialog {
	public interface OnAmbilWarnaListener {
		...
		void onNeutral(AmbilWarnaDialog dialog);
	}
	...
	public AmbilWarnaDialog(final Context context, int color, OnAmbilWarnaListener listener) {
		this(context, color, false, listener, "", false);
	}
	 ...
	 * @param listener an OnAmbilWarnaListener, allowing you to get back error or OK
	 */
	public AmbilWarnaDialog(final Context context, int color, boolean supportsAlpha, final OnAmbilWarnaListener listener, String neutral, boolean withNeutral) {
		...
		final View view = inflater.inflate(R.layout.ambilwarna_dialog, null);
        ...
        if (withNeutral){
            builder.setNeutralButton(neutral, new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
                    AmbilWarnaDialog.this.listener.onNeutral(AmbilWarnaDialog.this);
                }
            });
        }
